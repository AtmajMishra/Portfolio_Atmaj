    ...
    <section className="c-space section-spacing">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
          ...
          />
          <div className="z-10">
          <p className="headtext">Hi, I'm Atmaj Mishra</p>
          <p className="subtext">Over the last 2 years, I have developed my frontend and backend dev
       ...
       <Card style={{rotate:"30deg", top:"70%", left:"70%"}} image="assets/logos/csharp-pink.png"/>
        ...
        <div className="grid-special-color grid-4">
          ...
          gap-4 size-full">
            <p className="text-center headtext">Do you want to start a 
              project together?  </p>
              <CopyEmailButton/>
          </div>
        </div>
        ...
        <div className="grid-default-color grid-5">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">I specialize in a variety of languages, frameworks and tools that allow
